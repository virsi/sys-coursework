...
code segment	'code'
	...
	; данные
	;replaceWith 				DB	'' 
	ignoredChars                DB  '1234567890!@#$%^&*()_+=-[]{},.;:/\|<>?~абвгдеёжзийклмнопрстуфхцчшщъыьэюяАБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯ'  ; список игнорируемых символов
	...
	translateTo 					DB	'ХЦЧШЩ'	; символы на которые будет идти замена'	; символы на которые будет идти замена
...
cursiveSymbol           DB 00000000b ; символ, составленный из единичек (его курсивный вариант)
	...
	charToCursiveIndex 		DB 'Ч' ; символ для замены
	...
	signatureLine1				DB	179, 'Щепнов Филипп                                          ', 179
	Line1_length 					equ	$-signatureLine1
	signatureLine2				DB	179, 'ИУ5-42Б                                                ', 179
	Line2_length 					equ	$-signatureLine2
	signatureLine3				DB	179, 'Вариант #25                                            ', 179
	Line3_length 					equ	$-signatureLine3
	helpMsg DB '>tsr.com [/?] ', 10, 13
					DB ' [/?] - вывод данной справки', 10, 13
					DB '  TSR.COM - выгрузка резидента из памяти', 10, 13
					DB '  F5  - вывод ФИО и группы по таймеру в низ экрана', 10, 13
					DB '  F6  - включение и отключение курсивного вывода русского символа Ч', 10, 13
					DB '  F7  - включение и отключение частичной русификации клавиатуры([, W, X, I, O -> ХЦЧШЩ)', 10, 13
					DB '  F8  - включение и отключение режима ограничения ввода только латинскими буквами', 10, 13
